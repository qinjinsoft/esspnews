...
//    public static final String CLUSTER_NAME = "blog";
    public static final String HOST_IP = "180.76.104.153";
    ...
    public static boolean setMapping(String indexName, String typeName, XContentBuilder builder ) {
...
//            System.out.println(builder.String());
            ...
            EsUtils.setMapping("spnews", "news", builder);
        } catch (IOException e) {
            e.printStackTrace();
        }
